...
class Scores():
    ...
    def image_scores(self):
        self.image_sc = self.font.render(str(self.stats.score), True, self.text_color, (0, 0, 0))
        self.score_rect = self.image_sc.get_rect()
    ...
    def show_score(self):
        self.screen.blit(self.image_sc, self.score_rect)
